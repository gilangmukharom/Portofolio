<template>
  <main
    class="mt-10 md:mt-1 flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center min-h-[65vh] md:min-h-[80vh] m-12">
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hello World, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Gilang Mukharom</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="/img/profile_resizes.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  methods: {
    downloadPDF() {
      const pdfURL = 'https://drive.google.com/file/d/1lgHqVL1YPSvG9I3Nj_NXEBCvMb4mvJ2p/view?usp=sharing';
      // const pdfURL = '';

      const a = document.createElement('a');
      a.href = pdfURL;
      a.download = 'nama_file.pdf'; // Ganti dengan nama yang sesuai
